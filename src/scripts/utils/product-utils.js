module.exports = (function() {
  ...
  const dominantOptionsRgx = new RegExp( state.dominantOptions.join( "|" ), "gi" ); // /color|colour/gi; // NOTE : MAKE THIS INTO A LIST AND SOURCE IT IN THE GALLERY LISTENER SETUP SO SINGLAR LIST EXISTS
